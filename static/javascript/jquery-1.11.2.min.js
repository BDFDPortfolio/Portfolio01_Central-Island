/*
 * @Date         : 2022-09-22 16:35:18
 * @Author       : BDFD,bdfd2005@gmail.com
 * @Github       : https://github.com/bdfd
 * @LastEditTime : 2022-09-22 17:22:35
 * @LastEditors  : BDFD
 * @Description  :
 * @FilePath     : \static\javascript\jquery-1.11.2.min.js
...
!(function (a, b) {
	...
	var s = (function (a) {
		...
		function hb() {
			...
			function b(c, e) {
				return (
					a.push(c + " ") > d.cacheLength && delete b[a.shift()], (b[c + " "] = e)
				);
			}
			return b;
		}
		...
		m.extend({
			queue: function (a, b, c) {
				...
				return a
					? ((b = (b || "fx") + "queue"),
					  (d = m._data(a, b)),
					  c &&
							(!d || m.isArray(c) ? (d = m._data(a, b, m.makeArray(c))) : d.push(c)),
					  d || [])
					: void 0;
			},
			dequeue: function (a, b) {
				...
				"inprogress" === e && ((e = c.shift()), d--),
					e &&
						("fx" === b && c.unshift("inprogress"), delete f.stop, e.call(a, g, f)),
					!d && f && f.empty.fire();
			},
				...
				setup: function () {
					return m.nodeName(this, "form")
						...
						: void m.event.add(this, "click._submit keypress._submit", function (a) {
								var b = a.target,
									c =
										m.nodeName(b, "input") || m.nodeName(b, "button") ? b.form : void 0;
								c &&
	...
	function Yb(a, b, c) {
		...
		if (0 >= e || null == e) {
			if (
				((e = Jb(a, b, f)), (0 > e || null == e) && (e = a.style[b]), Hb.test(e))
			)
				return e;
					...
					return {
						send: function (c, d) {
							var e,
								...
								g = ++Wc;
							if (
								(f.open(a.type, a.url, a.async, a.username, a.password), a.xhrFields)
							)
